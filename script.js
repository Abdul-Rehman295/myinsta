const arr = [
    {
        ...
        story:"https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8bW9kZWx8ZW58MHx8MHx8fDA%3D"
    },
    {
...
let clutter = '' ;
arr.forEach(function(data , id){
const value = data.dp;
clutter += ` <div class="story">
<img src="${value}" alt="story${id}" id='${id}'>
</div>`;
});
let stori = document.querySelector('#stori');
stori.innerHTML = clutter ;
stori.addEventListener('click',function(e){
...
//for like
let like = document.querySelectorAll('.ri-heart-3-fill');
let count = false;
